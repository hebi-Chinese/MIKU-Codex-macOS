...
- The MIKU preset additionally requires `mikuContractPass: true`, adapter contract `miku-native-v2-2026-07-20`, 15 support phrases, 4 permission presentations, and at least 56 SVG symbols. A wallpaper-only state must fail.
